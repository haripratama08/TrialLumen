<?php
    ...
    class Absensi_m extends Model{
        ...
        public static function cekAbsen($id_karyawan = null, $id_company = null, $id_cabang = null,$current_date=null,$lat_absen = null, $long_absen = null, $day_now = null, $current_time = null){
            ...
            if($cek_absensi_terakhir['status']){//TRUE LEWAT HARI
                ...
                if(in_array($jenis_jam_kerja,array('reguler','shift'))){
                    ...
                    $jadwal_absensi = array('status'=>true,
            ...
            // echo $jam_pulang;exit;
            $button_absensi = self::_getTogleButtonAbsensi($jenis_jam_kerja, $time_now, $start_absensi_masuk, $jam_masuk, $istirahat_mulai, $istirahat_selesai, $jam_pulang, $batas_absensi_pulang, $libur_shift);
        ...
        private static function _getTogleButtonAbsensi($jenis_jam_kerja = null, $time_now = null, $start_absensi_masuk = null, $jam_masuk = null, $istirahat_mulai = null, $istirahat_selesai = null, $jam_pulang = null, $batas_absensi_pulang = null, $libur_shift = null ){
            ...
            $button_absensi = array('toggle_absen_kerja'        => $toggle_absen_kerja,
        ...
        private static function _dataAbsensi($id_karyawan = null, $id_company = null, $current_date = '0000-00-00'){
        ...
        public static function _getLokasi($id_karyawan = null, $id_company = null, $lat_absen = null, $long_absen = null){
            ...
            $lokasi_kantor = DB::table('data_lokasi_kantor')
                                ...
                                // ->where('data_karyawan.id_karyawan', $id_karyawan);
                                
            // $lock_lokasi = DB::table("master_company")
            //                     ->selectRaw("id_company")
            //                     ->where('id_company', $id_company)
            //                     ->where('lock_lokasi', "1")
            //                     ->count();
            ...
            if(count($lokasi_kantor) > 0){
                ...
                if($lokasi == true){
                    $response_lokasi = array('status'=>true,
                ...
                $response_lokasi = array('status'=>false,
        ...
        public static function _cekAbsensiTerakhir($id_karyawan = null, $id_company = null, $current_time = '0000-00-00'){
            ...
            if($cek_absensi_terakhir!=null && $cek_absensi_terakhir->jenis_absen == 'shift'){//ADA ABSEN SHIFT
                ...
                if($current_time == '0000-00-00'){
                    ...
                    // $absensi_pulang = DATE_FORMAT(DATE_CREATE('2021-09-08'." ".$current_time),"Y-m-d H:i:s");
                    // echo $absensi_pulang;exit;
                }
                DB::enableQueryLog();
        ...
        //BUAT POST ABSEN
        public static function addAbsensi($table = null, $data = null){
            // $insert_absen = true;
            $insert_absen = DB::table($table)->insert($data);
            if($insert_absen){
                ...
                $response = array('success'=>false,
                                    'message'=>'Anda gagal melakukan absen, silahkan dicoba lagi');
        ...
        public static function getRekapAbsensi($id_company = null, $id_karyawan = null, $current_month = null){
            ...
            $data = array('jml_hadir'=>$jml_hadir,
                            'jml_izin'=>$jml_izin,
                            'jml_cuti'=>$jml_cuti,
        ...
        public static function getLastRowIAbsensiMasuk($id_karyawan){
        ...
        private static function dataAbsensiHariIni($data=array()){
            ...
            ->select(
                ...
                'am.tgl_absen','am.ket_kode','am.foto as foto_masuk','ap.foto as foto_absen_pulang',
            'im.foto as foto_ist_mulai','is.foto as foto_ist_selesai', 'am.kode_absen as kode_absensi',
            // DB::raw(
            ...
            'ap.jam_absen as absen_pulang','am.terlambat',
            'am.lokasi_absen as lokasi_masuk','ap.lokasi_absen as lokasi_pulang','im.lokasi_absen as lokasi_ist_mulai','is.lokasi_absen as lokasi_ist_selesai',
            'am.keterangan as keterangan_masuk','ap.keterangan as keterangan_pulang',
            'im.jam_absen AS ist_mulai','is.jam_absen AS ist_selesai',
            'is.keterangan as keterangan_istirahat_selesai',
            'im.keterangan as keterangan_istirahat_mulai',
            'ap.jam_absen AS jam_pulang', 'md.nama as nama_departemen',
            'mc.nama as nama_cabang', 'dk.nama_lengkap as nama_karyawan'
            )
            ->leftJoin('absensi_pulang as ap', 'ap.id_masuk', '=', 'am.id_absensi_masuk')
            ->leftJoin('istirahat_mulai as im', 'im.id_absensi_masuk', '=', 'am.id_absensi_masuk')
            ->leftJoin('istirahat_selesai as is', 'is.id_absensi_masuk', '=', 'am.id_absensi_masuk')
        ...
        public static function dataAbsensi($data = array()){
            ...
            'tgl_absen','ket_kode','foto_masuk','foto_absen_pulang',
            'foto_ist_mulai','foto_ist_selesai',
            'kode_absensi','absen_masuk',
            'absen_pulang','terlambat',
            'lokasi_masuk','lokasi_pulang','lokasi_ist_mulai','lokasi_ist_selesai',
            'ket_absen_masuk AS keterangan_masuk', 'ket_absen_pulang AS keterangan_pulang',
            'absen_ist_mulai AS ist_mulai','absen_ist_selesai AS ist_selesai',
            'ket_ist_selesai as keterangan_istirahat_selesai', 'ket_ist_mulai as keterangan_istirahat_mulai',
            'absen_pulang AS jam_pulang', 'ra.nama_departemen', 'ra.nama_cabang', 'ra.nama_karyawan')
            ...
            if(count($select_absensi) > 0){
                foreach($select_absensi as $rows){
                    ...
                    $data_absensi[] = array(
                        ...
                        'keterangan_masuk'    => $rows->keterangan_masuk!=null && $rows->keterangan_masuk!=''?$rows->keterangan_masuk:'-',
